        ...
        <footer className="mt-5 w-screen border-t-2">
            <div className="py-4 sm:flex sm:justify-around lg:gap-20">
                <div className="flex justify-evenly sm: sm:gap-20">
                    <div className="p-3">
                        <h2 className=" text-base font-libre font-semibold fontFamily">Institucional</h2>
                        <ul>
                            <li className="mt-2 font-libre">
                                <Link to="/Home">
                                   Sobre
                                </Link>
                            </li>
                    ...
                    <div className="p-3">
                        <h2 className="font-libre font-semibold">Planos</h2>
                        <ul>
                        <li className="mt-2 font-libre">
                                <Link to="/Home">
                                   Nossos planos
            ...
            <div className="text-center mt-2 sm:mt-1">
                <p className="text-sm text-center text-gray-500 ">© 2022 GamaBoss™ - All Rights Reserved. </p>
                <a href="#" className=" pb-3 text-sm text-center text-gray-500 ">Política de privacidade</a>
            </div>
        </footer>
    );
} 3
