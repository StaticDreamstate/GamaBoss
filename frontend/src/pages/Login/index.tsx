        ...
        <form className="w-5/6 pt-1 " onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between w-[300px] md:w-[332px] my-7">
            <div className="flex items-center">
              <input type="checkbox" />
              <label className="px-1 mr-10 font-400 text-[12px]" htmlFor="checkbox">
                Manter conectado
              </label>
            </div>
          ...
          <div className="flex flex-col items-center pb-[96px]">
            <Button className="w-20 h-10 px-3 py-6 text-center flex justify-center items-center ml-12 md:ml-7" buttonLabel="Entrar" type="submit" />
            <span className="font-400 text-[12px] my-3 ml-[31px] md:ml-0">
              Ainda não tem uma conta?
              <a className="font-600 ml-1  text-[12px] text-primary-blue-1" href="">
                Cadastre-se!
              </a>
            </span>
          </div>
