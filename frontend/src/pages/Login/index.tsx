...
export default function Login() {
  ...
  return (
    <main className="grid justify-items-center">
      ...
      />
      <div className="grid justify-items-center w-full z-10 md:rounded-[32px] md:border-2 md:border-primary-blue-1 md:mt-2 md:w-[400px] md:bg-white ">
        <h2 className="justify-self-center pt-10 font-600 text-mobile-size-24px leading-mobile-line-26.4px text-primary-blue-1">
